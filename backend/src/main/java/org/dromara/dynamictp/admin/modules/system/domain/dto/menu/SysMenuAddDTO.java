package org.dromara.dynamictp.admin.modules.system.domain.dto.menu;
 ...
 * @ClassName SysMenuAddDTO
 * @CreateTime 2023-12-28
 */

@Getter
@Setter
@Schema(name = "SysMenuAddDTO", description = "菜单管理 新增 DTO 对象")
public class SysMenuAddDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = 5007819256437156353L;
