...
/**
 * 代码生成表字段列管理 新增 DTO 对象
 *
 * @Author eachann <eachannchan@qq.com>
 * @ProjectName dynamic-tp-admin
 * @ClassName org.dromara.dynamictp.admin.modules.tools.domain.dto.generator.table.column.ToolGeneratorTableColumnAddDTO
 * @CreateTime 2024-08-26 - 22:13:50
 */

@Getter
@Setter
@Schema(name = "ToolGeneratorTableColumnAddDTO", description = "代码生成表字段列管理 新增 DTO 对象")
public class ToolGeneratorTableColumnAddDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = 6979882846688178412L;
