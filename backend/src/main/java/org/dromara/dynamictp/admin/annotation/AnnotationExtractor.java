...
package org.dromara.dynamictp.admin.annotation;
 ...
 * @ClassName org.dromara.dynamictp.admin.infrastructure.annotation.AnnotationExtractor
...
public class AnnotationExtractor {
    ...
    public static Map<String, String> extractAllControllerAnnotations() {
        return extractAllControllerAnnotations("org.dromara.dynamictp.admin.admin.controller");
    }
    ...
    public static void main(String[] args) {
        Map<String, LinkedHashMap<String, LinkedHashMap<List<String>, String>>> annotations =
                extractAllControllerMethodAnnotations("org.dromara.dynamictp.admin.admin.controller");
        annotations.forEach((controller, methods) -> {
