...
--
-- Dumping data for table `tool_generator_table`
--

LOCK TABLES `tool_generator_table` WRITE;
/*!40000 ALTER TABLE `tool_generator_table` DISABLE KEYS */;
INSERT INTO `tool_generator_table` (`id`, `table_name`, `table_comment`, `table_prefix`, `parent_package`, `module_name`, `parent_menu_id`, `author`, `create_user`, `create_user_id`, `create_time`, `update_user`, `update_user_id`, `update_time`, `status`, `is_deleted`) VALUES (1935983862816055297,'mon_file','文件管理','mon_','com.izpan','可',0,'l','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-07-27 20:44:30','1',1);
/*!40000 ALTER TABLE `tool_generator_table` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tool_generator_table_column`
--

LOCK TABLES `tool_generator_table_column` WRITE;
/*!40000 ALTER TABLE `tool_generator_table_column` DISABLE KEYS */;
INSERT INTO `tool_generator_table_column` (`id`, `table_id`, `table_name`, `column_name`, `property_name`, `column_comment`, `data_type`, `java_type`, `typescript_type`, `ordinal_position`, `is_i18n`, `is_required`, `is_list`, `is_search`, `search_type`, `is_added`, `is_edit`, `dict_code`, `render_type`, `create_user`, `create_user_id`, `create_time`, `update_user`, `update_user_id`, `update_time`, `status`, `is_deleted`) VALUES (1935983863206125570,1935983862816055297,'mon_file','order_id','orderId','订单ID','bigint','Long','number',2,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863222902785,1935983862816055297,'mon_file','order_no','orderNo','订单号码','varchar','String','string',3,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863227097090,1935983862816055297,'mon_file','category','category','分类1:上传 2:下载','varchar','String','string',4,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863231291393,1935983862816055297,'mon_file','location','location','存储位置 1:本地 2:Minio','varchar','String','string',5,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863239680002,1935983862816055297,'mon_file','name','name','文件名称','varchar','String','string',6,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863239680003,1935983862816055297,'mon_file','suffix','suffix','文件尾缀','varchar','String','string',7,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863243874306,1935983862816055297,'mon_file','path','path','文件路径','varchar','String','string',8,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863248068609,1935983862816055297,'mon_file','length','length','文件大小','int','Integer','number',9,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863248068610,1935983862816055297,'mon_file','size','size','文件大小(带单位)','varchar','String','string',10,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863252262913,1935983862816055297,'mon_file','uuid','uuid','文件UUID','varchar','String','string',11,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863256457218,1935983862816055297,'mon_file','content_type','contentType','文件类型','varchar','String','string',12,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863256457219,1935983862816055297,'mon_file','remark','remark','备注','varchar','String','string',13,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:36','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863260651521,1935983862816055297,'mon_file','create_user','createUser','创建用户','varchar','String','string',14,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:37','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1),(1935983863260651522,1935983862816055297,'mon_file','create_time','createTime','创建时间','datetime','LocalDateTime','string',16,'1','','1','','','','','','input','管理员',1740288148287545345,'2025-06-20 16:51:37','管理员',1740288148287545345,'2025-06-20 16:51:50','1',1);
/*!40000 ALTER TABLE `tool_generator_table_column` ENABLE KEYS */;
UNLOCK TABLES;
